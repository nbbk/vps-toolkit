...
WEB_ROOT=/; ! web_safe_root
WEB_ROOT=/opt/vps-web; web_safe_root
workspace_valid_name workspace-1; ! workspace_valid_name 'bad;id'
web_valid_name wordpress; ! web_valid_name '../site'
basics_valid_package docker-compose-plugin; ! basics_valid_package 'curl | sh'
