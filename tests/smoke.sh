...
valid_port 22; valid_port 65535; if valid_port 0 || valid_port 65536 || valid_port abc; then exit 1; fi
parse_port_spec 443 tcp; parse_port_spec 8000:8100 udp; if parse_port_spec 9000:8000 tcp || parse_port_spec '22;id' tcp; then exit 1; fi
valid_size_mb 128; valid_size_mb 262144; if valid_size_mb 127 || valid_size_mb '1G'; then exit 1; fi
...
basics_valid_package curl; basics_valid_package docker-compose-plugin; if basics_valid_package 'curl;id'; then exit 1; fi
echo "smoke: PASS"
